...
namespace Klyte.AirplaneLineTool.Extensors
{
    class TLMAirplaneModifyRedirects : Redirector
    {
        ...
        public Color GetColor(ushort vehicleID, ref Vehicle data, InfoManager.InfoMode infoMode)
        {
            ...
            else
            {
                ...
                if (currentSubMode == InfoManager.SubInfoMode.WindPower && (data.m_flags & (Vehicle.Flags.Importing | Vehicle.Flags.Exporting)) != Vehicle.Flags.Arriving)
                {
